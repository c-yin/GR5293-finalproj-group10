...
<br>
Advanced data measures and analysis player's ability in one specific area:
...
__This may explain how the NBA teams makes it to keeping throwing more 3 pointers and in the meanwhile raise the FG% of 2 pointers. They decrease the attempts to shoot from 'low efficiency' regions and focus more near the basket.__
...
The TS% has increased around 10% for the past 15 years. Please note that this is quite a huge improvement in shooting ability. Among all the positions, _bigs_ improve the most.
...
The pace of the game is increasing: the Assit and Turnover both increases. Players tend to share the ball and assist others.
